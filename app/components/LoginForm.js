    ...
    <form onSubmit={handleSubmit} className="mt-8 space-y-6">
      ...
      <div className="space-y-3">
        ...
        <button
          ...
          disabled={isLoading}
          className="w-full flex justify-center items-center gap-3 py-2 px-4 border border-[#DDE5E7] dark:border-[#333333] rounded-md shadow-sm text-sm font-medium text-[black] dark:text-[white] hover:bg-[#F8F9FA] dark:hover:bg-[#1A1A1A] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#5fbfc0] disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {isLoading ? (
