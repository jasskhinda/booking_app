...
export default function RatingForm({ trip, onRatingSubmitted }) {
  ...
  return (
    <div className="bg-white rounded-lg p-4 shadow-sm border border-[#DDE5E7]">
      <h3 className="text-lg font-medium mb-4 text-primary">Rate your trip</h3>
      ...
      <form onSubmit={handleSubmitRating}>
        <div className="mb-4">
          ...
          <div className="text-center mt-2 text-sm text-primary/70">
        ...
        <button
          ...
          className="w-full inline-flex justify-center items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-button-text bg-button hover:bg-accent focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-accent disabled:opacity-50"
        >
