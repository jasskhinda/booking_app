...
function SignupContent() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Hero Section with Parallax and Signup Form */}
      <section className="hero-parallax signup-form-container">
        ...
        <div className="relative z-10 w-full max-w-md mx-auto px-4">
          <div className="bg-white/90 backdrop-blur-sm rounded-xl shadow-lg border border-[#5fbfc0]/20 p-6 md:p-8">
            <div className="text-center mb-6">
              <h1 className="text-3xl font-bold text-[#5fbfc0] mb-2">Create Account</h1>
              <p className="text-gray-600">
                Join Compassionate Care Transportation
              </p>
